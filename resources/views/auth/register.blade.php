<!-- filepath: c:\~Amikom~\Semester 4\#WebSmartWatch\resources\views\auth\register.blade.php -->
@extends('layout.app')
    ...
    <div class="flex justify-center items-center h-screen bg-gray-100">
        <div class="w-full max-w-md bg-white rounded-lg shadow-md p-6">
            ...
            <p class="text-sm text-center text-gray-600 mt-4">
                Already have an account? <a href="{{ route('login') }}" class="text-pink-500 hover:underline">Login</a>
            </p>
        </div>
    </div>
@endsection